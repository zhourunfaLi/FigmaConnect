...
export function CityPage() {
  const cities = [
    { name: '威尼斯', img: '/images/city-01.jpg' },
    { name: '梵蒂冈', img: '/images/city-02.jpg' },
    { name: '巴黎', img: '/images/city-03.jpg' },
    { name: '罗马', img: '/images/city-04.jpg' },
    { name: '劳特布莱嫩', img: '/images/city-05.jpg' },
    { name: '苏黎世', img: '/images/city-06.jpg' },
    { name: '纽约', img: '/images/city-07.jpg' },
    { name: '伦敦', img: '/images/city-08.jpg' },
    { name: '阿姆斯特丹', img: '/images/city-09.jpg' },
    { name: '维也纳', img: '/images/city-10.jpg' },
