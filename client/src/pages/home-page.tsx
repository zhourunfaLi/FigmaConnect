...
const mockArtworks = [
  // 艺术作品
  {
    ...
    imageUrl: "../assets/design/img/works-01.png",
    likes: 1200,
    isPremium: true,
    themeId: "art",
    artType: "painting"
  ...
  // 城市风光
  {
    ...
    imageUrl: "../assets/design/img/city-01.png",
    likes: 1000,
    isPremium: false,
    themeId: "city",
    cityId: "venice"
  },
  {
    ...
    title: "梵蒂冈圣彼得大教堂",
    description: "天主教的中心",
    imageUrl: "../assets/design/img/city-02.png",
    likes: 800,
    isPremium: true,
    themeId: "city",
    cityId: "vatican"
  },
  {
    ...
    title: "巴黎铁塔",
    description: "浪漫之都的象征",
    imageUrl: "../assets/design/img/city-03.png",
    likes: 1200,
    isPremium: true,
    themeId: "city",
    cityId: "paris"
  },
  {
    ...
    imageUrl: "../assets/design/img/city-04.png",
    likes: 950,
    isPremium: false,
    themeId: "city",
    cityId: "rome"
  },
  {
    ...
    imageUrl: "../assets/design/img/city-05.png",
    likes: 750,
    isPremium: true,
    themeId: "city",
  ...
  // Add more city images here...  (Assume more images exist in /src/assets/design/img/)
  {
    ...
    title: "纽约时代广场",
    description: "繁华都市的中心",
    imageUrl: "../assets/design/img/city-06.png", // Replace with actual image path
    likes: 1500,
    isPremium: false,
    themeId: "city",
    cityId: "newyork"
  },
  {
    ...
    imageUrl: "../assets/design/img/city-07.png", // Replace with actual image path
    likes: 1100,
    isPremium: true,
    themeId: "art",
    artType: "sculpture"
