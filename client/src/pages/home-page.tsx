...
const mockArtworks = [
  // 艺术作品
  {
    ...
    imageUrl: "/client/src/assets/design/img/works-01.jpg",
    likes: 1200,
    isPremium: true,
    themeId: "art",
    artType: "painting"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/works-02.jpg",
    likes: 980,
    isPremium: false,
    themeId: "art",
    artType: "modern"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/works-03.jpg",
    likes: 850,
    isPremium: true,
    themeId: "art",
    artType: "photography"
  ...
  // 城市风光
  {
    ...
    imageUrl: "/client/src/assets/design/img/city-01.jpg",
    likes: 1000,
    isPremium: false,
    themeId: "city",
    cityId: "venice"
  },
  {
    ...
    title: "梵蒂冈圣彼得大教堂",
    description: "天主教的中心",
    imageUrl: "/client/src/assets/design/img/city-02.jpg",
    likes: 800,
    isPremium: true,
    themeId: "city",
    cityId: "vatican"
  },
  {
    ...
    title: "巴黎铁塔",
    description: "浪漫之都的象征",
    imageUrl: "/client/src/assets/design/img/city-03.jpg",
    likes: 1200,
    isPremium: true,
    themeId: "city",
    cityId: "paris"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/city-04.jpg",
    likes: 950,
    isPremium: false,
    themeId: "city",
    cityId: "rome"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/city-05.jpg",
    likes: 750,
    isPremium: true,
    themeId: "city",
  ...
  // Add more city images here...  (Assume more images exist in /src/assets/design/img/)
  {
    ...
    title: "纽约时代广场",
    description: "繁华都市的中心",
    imageUrl: "/client/src/assets/design/img/city-06.jpg", // Replace with actual image path
    likes: 1500,
    isPremium: false,
    themeId: "city",
    cityId: "newyork"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/city-07.jpg", // Replace with actual image path
    likes: 1100,
    isPremium: true,
    themeId: "art",
    artType: "sculpture"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/works-04.jpg",
    likes: 920,
    isPremium: true,
    themeId: "art",
    artType: "traditional"
  },
  {
    ...
    imageUrl: "/client/src/assets/design/img/works-05.jpg",
    likes: 760,
    isPremium: false,
    themeId: "art",
    artType: "abstract"
